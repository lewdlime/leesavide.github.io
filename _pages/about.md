...
For using this in the [_config.yml](https://github.com/gdg-managua/jekyll-mdl/master/_config.yml) select the type of layout, rebuild the website and voilà :smile:
